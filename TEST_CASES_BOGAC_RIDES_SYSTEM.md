...
| 74 | **Password Reset** | Expired Reset Token | 1. Request password reset<br>2. Wait 10+ minutes<br>3. Click reset link<br>4. Try to reset password | ❌ Expected: System displays validation error message: "Invalid or expired reset token" |
