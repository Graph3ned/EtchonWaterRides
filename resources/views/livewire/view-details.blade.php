                                    ...
                                    <div class="rounded-lg p-2 sm:p-3 text-center border-2 {{ $ride->is_active ? 'bg-green-50 border-green-200' : 'bg-red-100 border-red-300' }} hover:shadow-md transition-shadow duration-200">
                                        ...
                                        <div class="mb-2 flex justify-center">
                                            @if (!empty($ride->image_path))
                                                <img src="{{ asset('storage/'.$ride->image_path) }}" 
                                                     alt="{{ $ride->identifier }}" 
                                                     class="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-lg object-cover border border-gray-200" />
                                            @else
                                                <div class="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-lg border border-dashed border-gray-300 bg-gray-50 flex items-center justify-center">
