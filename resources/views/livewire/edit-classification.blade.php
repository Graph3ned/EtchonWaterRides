                                            ...
                                            <div class="flex space-x-1">
                                                ...
                                                @if(!empty(trim($identifier)) && ($identifierInDatabase[$iIndex] ?? false))
                                                    <button type="button" 
                                                            ...
                                                            class="inline-flex items-center px-3 py-2 {{ ($identifierStatus[$iIndex] ?? true) ? 'bg-blue-500 hover:bg-blue-600' : 'bg-gray-500 hover:bg-gray-600' }} 
                                                ...
                                                @if(!empty(trim($identifier)) && ($identifierInDatabase[$iIndex] ?? false))
                                                    <button type="button" 
                                                            ...
                                                            class="inline-flex items-center px-3 py-2 bg-red-500 hover:bg-red-600 
                                                                   text-white rounded-lg transition-all duration-200 text-sm font-medium
                                                                   shadow hover:shadow-md transform hover:-translate-y-0.5">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
